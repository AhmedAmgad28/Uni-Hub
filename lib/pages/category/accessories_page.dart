...
import 'package:project_v2/pages/category/elctronics_page.dart';
import 'package:project_v2/pages/category/other_page.dart';
...
class AccessoriesPage extends StatefulWidget {
  ...
  static String id = 'AccessoriesPage';

  @override
  State<AccessoriesPage> createState() => _AccessoriesPage();
}

class _AccessoriesPage extends State<AccessoriesPage> {
  ...
  void initState() {
    super.initState();
    _futureItemsModel = getitemsByCategory('Accessories');
  }
